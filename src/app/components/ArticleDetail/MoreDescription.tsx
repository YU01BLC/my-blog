    ...
    <>
      <CardActions disableSpacing>
        <Box
          ...
          sx={{ marginLeft: 'auto', cursor: 'pointer', '&:hover': { color: '#ed6c02' } }}
        >
          {expanded ? <Typography>閉じる</Typography> : <Typography>続きを読む</Typography>}
        </Box>
      </CardActions>
      <Collapse in={expanded} timeout='auto' unmountOnExit>
        <Box data-testid='moreDescription-more--contents'>
